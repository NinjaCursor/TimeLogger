...
//
//        @Override
//        public CompletableFuture<AccumulatedData> getData() throws Exception {
//            SequentialRunnable<List<AccumulatedData>> runnable = new SequentialRunnable<AccumulatedData>() {
//                @Override
//                public boolean run() {
